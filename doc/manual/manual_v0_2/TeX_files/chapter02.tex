...
\begin{figure}[H]
	...
	\begin{subfigure}[b]{0.7\textwidth}
		\centering
		\includegraphics[width=\textwidth, angle = -90]{IMG_0328.jpg}
	...
	\begin{subfigure}[b]{0.7\textwidth}
		\centering
		\includegraphics[width=\textwidth, angle = -90]{IMG_0327.jpg}
...
\end{figure}
\section{Turn on continuous scanning (MANDEYE DEV/PRO)}
...
\section{Data structure on USB drive (MANDEYE DEV/PRO)}
