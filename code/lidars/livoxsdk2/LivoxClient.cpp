...
namespace mandeye
{
    ...
    void LivoxClient::QueryInternalInfoCallback(
        livox_status status, uint32_t handle, LivoxLidarDiagInternalInfoResponse* response, void* client_data)
    {
        ...
        printf(
            "Host point cloud ip addr:%u.%u.%u.%u, host point cloud port:%u, lidar point cloud "
            "port:%u.\n",
            host_point_ipaddr[0],
            host_point_ipaddr[1],
            host_point_ipaddr[2],
