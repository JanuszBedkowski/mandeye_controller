...
static const std::unordered_map<int, LibSerial::BaudRate> baud_map = {
	{50, LibSerial::BaudRate::BAUD_50},			  {75, LibSerial::BaudRate::BAUD_75},			{110, LibSerial::BaudRate::BAUD_110},
	{134, LibSerial::BaudRate::BAUD_134},		  {150, LibSerial::BaudRate::BAUD_150},			{200, LibSerial::BaudRate::BAUD_200},
	{300, LibSerial::BaudRate::BAUD_300},		  {600, LibSerial::BaudRate::BAUD_600},			{1200, LibSerial::BaudRate::BAUD_1200},
	{1800, LibSerial::BaudRate::BAUD_1800},		  {2400, LibSerial::BaudRate::BAUD_2400},		{4800, LibSerial::BaudRate::BAUD_4800},
	{9600, LibSerial::BaudRate::BAUD_9600},		  {19200, LibSerial::BaudRate::BAUD_19200},		{38400, LibSerial::BaudRate::BAUD_38400},
	{57600, LibSerial::BaudRate::BAUD_57600},	  {115200, LibSerial::BaudRate::BAUD_115200},	{230400, LibSerial::BaudRate::BAUD_230400},
	{460800, LibSerial::BaudRate::BAUD_460800},	  {500000, LibSerial::BaudRate::BAUD_500000},	{576000, LibSerial::BaudRate::BAUD_576000},
	{921600, LibSerial::BaudRate::BAUD_921600},	  {1000000, LibSerial::BaudRate::BAUD_1000000}, {1152000, LibSerial::BaudRate::BAUD_1152000},
	{1500000, LibSerial::BaudRate::BAUD_1500000}, {2000000, LibSerial::BaudRate::BAUD_2000000}, {2500000, LibSerial::BaudRate::BAUD_2500000},
	{3000000, LibSerial::BaudRate::BAUD_3000000}, {3500000, LibSerial::BaudRate::BAUD_3500000}, {4000000, LibSerial::BaudRate::BAUD_4000000},
};
...
int main(int argc, char** argv)
{
	...
	if(!global::ntripHost.empty() && !global::ntripMountPoint.empty())
	{
		...
		global::gnssClient.setNtripClient(
			global::ntripUser, global::ntripPassword, global::ntripMountPoint, global::ntripHost, std::to_string(global::ntripPort));
	}
